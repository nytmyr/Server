...
RULE_INT(Character, ClearXTargetDelay, 10, "Seconds between two uses of the #clearxtargets command (Set to 0 to disable)")
...
RULE_INT(Pathing, RoamPointMaxZVariation, 100, "Default 100. Max allowed Z variation whwm finding new rom points.")
RULE_BOOL(Pathing, OutputStuckToDiscord, true, "Outputs stuck roaming mobs to Discord.")
RULE_INT(Pathing, StuckCountLimit, 5, "Defult 5, count required to trigger stuck alert.")
RULE_CATEGORY_END()
...
RULE_INT(Bots, MageEpicPet, 1, "1 default requiring epic, 0 disabled, 2 enabled no epic requirement")
...
RULE_BOOL(Bots, CanClickMageEpicV1, true, "Whether or not bots are allowed to click Mage Epic 1.0")
...
RULE_BOOL(Bots, AllowGroupCures, true, "Whether or not bots are allowed to cast group cures, default true.")
...
RULE_INT(Bots, NukeResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, RootResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, InCombatBuffResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, LifetapResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, SnareResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, DoTResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, DispelResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, CharmResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, SlowResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, DebuffResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, MezResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, HateReduxResistLimit, 150, "150 Default. This is the resist gap where bots will refuse to cast due to a high resist chance.")
...
RULE_INT(Bots, HoTHealPercentLimit, 80, "80 Default. Percent at which bots will START HoT healing (when target doesn't have aggro, otherwise will do percentage heal till max limit).")
...
RULE_INT(Bots, SingleTargetHealLimit, 55, "55 Default. Percent at which bots will START single target healing.")
...
RULE_INT(Bots, OOCPercentageHealPercentLimit, 60, "60 Default. Percent at which bots will STOP percentage based healing.")
...
RULE_INT(Bots, TierThreeBotSpawnLimitUnlockLevelRequirement, 25, "25 Default. 0 Disabled. Level requirement to unlock the Tier 3 bot spawn limit.")
RULE_INT(Bots, TierFourBotSpawnLimitUnlockLevelRequirement, 40, "40 Default. 0 Disabled. Level requirement to unlock the Tier 4 bot spawn limit.")
RULE_INT(Bots, TierFiveBotSpawnLimitUnlockLevelRequirement, 50, "50 Default. 0 Disabled. Level requirement to unlock the Tier 5 bot spawn limit.")
...
RULE_REAL(Bots, NormalMeleeRangeDistance, 0.50, "Multiplier of the max melee range at which a bot will stand in melee combat. 0.50 Recommended, max melee for all abilities to land.")
RULE_REAL(Bots, PercentMinMeleeDistance, 0.60, "Multiplier of the NormalMeleeRangeDistance - Minimum distance from target a bot will stand while in melee combat before trying to adjust. 0.60 Recommended.")
RULE_REAL(Bots, TauntNormalMeleeRangeDistance, 0.35, "Multiplier of the max melee range at which a taunting bot will stand in melee combat. 0.35 Recommended, closer than others .")
RULE_REAL(Bots, PercentTauntMinMeleeDistance, 0.1, "Multiplier of TauntNormalMeleeRangeDistance - Minimum distance from target a taunting bot will stand while in melee combat before trying to adjust. 0.1 Recommended.")
...
RULE_BOOL(QueryServ, PlayerLogIssuedBotCommands, false, "Log player issued bot commands")
...
RULE_INT(Cheat, AntiCheatExemptDuration, 3, "Duration of cheat exemption. Default 3 = 3 seconds")
RULE_CATEGORY_END()
...
RULE_STRING(Command, SubAltExampleColor, "slate_blue", "Color for command help windows")
...
RULE_STRING(Command, AltActionableColor, "goldenrod", "Color for command help windows")
...
RULE_INT(Vegas, ClassicZoneNPCIDMax, 181999, "181999 Default. Maximum NPC ID to select from for Vegas items for Classic Zone drops.")
RULE_INT(Vegas, ClassicZoneNPCIDMin, 1, "1 Default. Minimum NPC ID to select from for Vegas items for Classic Zone drops.")
RULE_REAL(Vegas, DifficultyBonusMinMaxValue, 249801, "249801 Default. Maximum Min Bonus Difficulty limit.")
RULE_REAL(Vegas, DifficultyFloor, 21.00, "21.00 Default. Floor of difficulty that anything lower will default to as a minimum.")
RULE_REAL(Vegas, DifficultyFloorBonusMax, 31.5, "31.5 Default. Default Bonus Max of what anything below DifficultyFloor difficulty will search for.")
RULE_REAL(Vegas, DifficultyFloorBonusMin, 21.0, "21.0 Default. Default Bonus Min of what anything below DifficultyFloor difficulty will search for.")
RULE_REAL(Vegas, DifficultyFloorBonusMinMultiplier, .5, ".5 Default. Min Bonus Difficutly multiplier of what anything below DifficultyFloor difficulty will search for.")
RULE_REAL(Vegas, DifficultyFloorMax, 31.5, "31.5 Default. Default Max of what anything below DifficultyFloor difficulty will search for.")
RULE_REAL(Vegas, DifficultyFloorMin, 21.0, "21.0 Default. Default Min of what anything below DifficultyFloor difficulty will search for.")
RULE_REAL(Vegas, DifficultyFloorMinMultiplier, .5, ".5 Default. Min Difficutly multiplier of what anything below DifficultyFloor difficulty will search for.")
RULE_REAL(Vegas, DifficultyMinMaxValue, 249801, "249801 Default. Maximum Min Difficulty limit.")
RULE_REAL(Vegas, DifficultyMinMultiplier, .5, ".5 Default. Min Difficutly multiplier for anything above DifficultyFloor.")
RULE_BOOL(Vegas, EnableAltCurrencySellElemental, true, "Enables the ability to resell Elemental Gear Coin bought items to alternate currency merchants")
RULE_BOOL(Vegas, EnableAltCurrencySellOrnate, true, "Enables the ability to resell Ornate Gear Coin bought items to alternate currency merchants")
RULE_BOOL(Vegas, EnableAltCurrencySellShard, true, "Enables the ability to resell Shard bought items to alternate currency merchants")
RULE_BOOL(Vegas, EnableVegasDrops, true, "True Default. Toggles on/off Vegas Drops.")
RULE_BOOL(Vegas, EnableVegasKillAchievements, true, "True Default. Toggles on/off Vegas Kill Achievements .")
RULE_INT(Vegas, EpicTokenItemID, 550001, "550001 Default. Item ID for an Epic Token.")
RULE_REAL(Vegas, EpicTokenRaidRollMultiplier, 1.0, "1.0 Default. Multiplier ontop of current raid chances, formula is EpicTokenRollMax - raw shard value amount.")
RULE_INT(Vegas, EpicTokenRollMax, 2500, "2500 Default. Maximum Roll for an Epic Token. 1-2500 is a 0.04% chance.")
RULE_BOOL(Vegas, EquipVegasDrops, false, "False Default. Toggles on/off the equipping of Vegas Drops for NPCs.")
RULE_INT(Vegas, KunarkZoneNPCIDMax, 181999, "181999 Default. Maximum NPC ID to select from for Vegas items for Kunark Zone drops.")
RULE_INT(Vegas, KunarkZoneNPCIDMin, 1, "1 Default. Minimum NPC ID to select from for Vegas items for Kunark Zone drops.")
RULE_INT(Vegas, LevelDifferenceForVegasDrops, 10, "10 Default. Maximum level difference between mob and highest getting kill credit.")
RULE_INT(Vegas, LuclinZoneNPCIDMax, 224999, "224999 Default. Maximum NPC ID to select from for Vegas items for Luclin Zone drops.")
RULE_INT(Vegas, LuclinZoneNPCIDMin, 110000, "110000 Default. Minimum NPC ID to select from for Vegas items for Luclin Zone drops.")
RULE_INT(Vegas, MaxLevelBeforeRespawnLockoutStopsForVegasLoot, 10, "Default 10. This is the maximum level before lockouts stop on vegas loot spawn points (newbie zones can be farmed for quick respawns. Triggers along with QuickRespawnVegasLootLockoutPeriod)")
RULE_INT(Vegas, MaxNPCIDToTriggerVegasLoot, 499999, "499999 Default. NPC ID must be less than this value to trigger Vegas loot.")
RULE_REAL(Vegas, MaxValueBeforeMinDiffAdjustment, 499602.00, "499602 Default. Maximum difficulty before minimum difficulties start getting adjusted.")
RULE_REAL(Vegas, NormalMinDifficultyMultiplier, .5, ".5 Default. Min Difficutly multiplier for Normal Spawns.")
RULE_INT(Vegas, MaxVegasItemID, 799999, "799999 Default. Maximum Item ID to select for Vegas items.")
RULE_REAL(Vegas, MinBonusDifficultyCapIfOverMaxValue, 249801, "249801 Default. Minimum Bonus Difficulty value if difficulty goes over Max Value cap.")
RULE_REAL(Vegas, MinDifficultyCapIfOverMaxValue, 249801, "249801 Default. Minimum Difficulty value if difficulty goes over Max Value cap.")
RULE_REAL(Vegas, MinDifficultyToTriggerVegasLoot, 0.00, "0 Default. Difficulty must be greater than this value to trigger Vegas loot.")
RULE_INT(Vegas, MinNPCIDToTriggerVegasLoot, 1000, "1000 Default. NPC ID must be greater than this value to trigger Vegas loot.")
RULE_INT(Vegas, MinLevelForEpicToken, 45, "45 Default. Minimum Level to be eligible for Epic Token Drops.")
RULE_INT(Vegas, MinStatusToBypassVegasLootLogging, 100, "100 Default. Minimum status to be ignored for logging Vegas loot.")
RULE_INT(Vegas, MinStatusToBypassVegasDiscordLogging, 100, "100 Default. Minimum status to be ignored for logging Vegas loot to Discord.")
RULE_INT(Vegas, MinStatusToBypassVegasKillAchievements, 100, "100 Default. Minimum status to be ignored for Vegas kill achievements.")
RULE_INT(Vegas, MinStatusToBypassVegasLootCooldown, 100, "100 Default. Minimum status to ignore loot cooldown.")
RULE_REAL(Vegas, MinValueToCapBonusRollMin, 249801, "249801 Default. Minimum difficulty before bonus roll minimum gets capped.")
RULE_INT(Vegas, MinVegasItemID, 600000, "600000 Default. Minimum Item ID to select for Vegas items.")
RULE_INT(Vegas, NormalBonusVegasRollCount, 1, "1 Default. Count of Bonus Vegas Rolls for normal targets.")
RULE_INT(Vegas, NormalBonusVegasRollUpperLimit, 50, "50 Default. Maximum Roll for Normal target Bonus Vegas Rolls, 1-50 is a 2% chance.")
RULE_REAL(Vegas, NormalMinDifficultyBonusMultiplier, 1.0, "1.0 Default. Min Bonus Difficutly multiplier for Normal Spawns.")
RULE_REAL(Vegas, NormalMaxDifficultyBonusMultiplier, 2.0, "2.0 Default. Max Bonus Difficutly multiplier for Normal Spawns.")
RULE_REAL(Vegas, NormalMaxDifficultyMultiplier, 1.2, "1.2 Default. Max Difficutly multiplier for Normal Spawns.")
RULE_REAL(Vegas, NormalTargetBonusRollMultiplier, 1, "1 Default. Multiplier for bonus normal rolls to hit (1 = 100% of max, so no reduced chance) 1-4 is normal.")
RULE_REAL(Vegas, NormalTargetRaidRollMultiplier, 1, "1 Default. Multiplier for normal target raid rolls to hit (1 = 100% of max, so no reduced chance) 1-4 is normal.")
RULE_INT(Vegas, NormalTargetEpicTokenRollCount, 1, "1 Default. Roll counts for an Epic Token on Normal Targets.")
RULE_REAL(Vegas, NormalTargetRollMultiplier, 1, "1 Default. Multiplier for normal rolls to hit (1 = 100% of max, so no reduced chance) 1-10 is normal.")
RULE_INT(Vegas, NormalTargetRollsCount, 1, "1 Default. Number of Normal Vegas rolls a normal target gets.")
RULE_INT(Vegas, NormalVegasRollUpperLimit, 10, "10 Default. Normal Mob Maximum Roll for Vegas Rolls, 1-10 is a 10% chance.")
RULE_INT(Vegas, NPCNotCountAsVegasLootFive, 1, "NPC ID of a raid target that will not count for Vegas loot.")
RULE_INT(Vegas, NPCNotCountAsVegasLootFour, 1, "NPC ID of a raid target that will not count for Vegas loot.")
RULE_INT(Vegas, NPCNotCountAsVegasLootOne, 1, "NPC ID of a raid target that will not count for Vegas loot.")
RULE_INT(Vegas, NPCNotCountAsVegasLootThree, 1, "NPC ID of a raid target that will not count for Vegas loot.")
RULE_INT(Vegas, NPCNotCountAsVegasLootTwo, 1, "NPC ID of a raid target that will not count for Vegas loot.")
RULE_INT(Vegas, NPCSpecialIDPassesLootCheckOne, 500101, "NPC ID an NPC that will automatically pass the eligiblity checks for Vegas loot.")
RULE_INT(Vegas, NPCSpecialIDPassesLootCheckTwo, 1, "NPC ID an NPC that will automatically pass the eligiblity checks for Vegas loot.")
RULE_INT(Vegas, NPCSpecialIDPassesLootCheckThree, 1, "NPC ID an NPC that will automatically pass the eligiblity checks for Vegas loot.")
RULE_INT(Vegas, NPCSpecialIDPassesLootCheckFour, 1, "NPC ID an NPC that will automatically pass the eligiblity checks for Vegas loot.")
RULE_INT(Vegas, NPCSpecialIDPassesLootCheckFive, 1, "NPC ID an NPC that will automatically pass the eligiblity checks for Vegas loot.")
RULE_INT(Vegas, PoPZoneNPCIDMax, 224999, "224999 Default. Maximum NPC ID to select from for Vegas items for PoP Zone drops.")
RULE_INT(Vegas, PoPZoneNPCIDMin, 150000, "150000 Default. Minimum NPC ID to select from for Vegas items for PoP Zone drops.")
RULE_INT(Vegas, QuickRespawnMaxToTriggerLockout, 180, "Default 180. This is the respawn duration at which spawns will begin to bypass vegas loot lockouts.")
RULE_INT(Vegas, QuickRespawnVegasLootLockoutPeriod, 180, "Default 180. This is minimum amount of respawn time a spawn point must have to avoid lockouts for Vegas Loot.")
RULE_INT(Vegas, RaidBonusVegasRollCount, 1, "1 Default. Count of Bonus Vegas Rolls for raid target.")
RULE_INT(Vegas, RaidBonusVegasRollUpperLimit, 4, "4 Default. Maximum Roll for Raid target Bonus Vegas Rolls, 1-4 is a 25% chance.")
RULE_REAL(Vegas, RaidMaxDifficultyBonusMultiplier, 2.75, "2.75 Default. Max Bonus Difficutly multiplier for Raid Spawns.")
RULE_REAL(Vegas, RaidMaxDifficultyMultiplier, 1.5, "1.5 Default. Max Difficutly multiplier for Raid Spawns.")
RULE_REAL(Vegas, RaidMinDifficultyBonusMultiplier, 1.5, "1.5 Default. Min Bonus Difficutly multiplier for Raid Spawns.")
RULE_REAL(Vegas, RaidMinDifficultyMultiplier, .75, ".75 Default. Min Difficutly multiplier for Raid Spawns.")
RULE_INT(Vegas, RaidTargetBaseRaidRollsCount, 2, "2 Default. Number of Normal Raid Target gets for Raid Vegas rolls.")
RULE_REAL(Vegas, RaidTargetBonusRollMultiplier, 1, "1 Default. Multiplier for bonus raid rolls to hit (.5 = 50% of max, so 2x chance) 1-50 is normal, .5 would be a 1-25.")
RULE_REAL(Vegas, RaidTargetRaidRollMultiplier, 1, "1 Default. Multiplier for raid target raid rolls to hit (1 = 100% of max, so no reduced chance) 1-4 is normal.")
RULE_INT(Vegas, RaidTargetEpicTokenRollCount, 1, "1 Default. Roll counts for an Epic Token on Raid Targets.")
RULE_REAL(Vegas, RaidTargetNormalRollMaxDifficulty, 1131570.0, "1131570.0 Default. Maximum Difficulty a Raid Target can be to receive regular Vegas Rolls (Don't want mobs dropping same tables after a certain point).")
RULE_INT(Vegas, RaidTargetNormalRollsCount, 4, "4 Default. Number of Normal Vegas rolls a raid target gets.")
RULE_INT(Vegas, RaidTargetNotCountAsRaidFive, 1, "NPC ID of a raid target that will not count for Raid rolls on Vegas loot.")
RULE_INT(Vegas, RaidTargetNotCountAsRaidFour, 1, "NPC ID of a raid target that will not count for Raid rolls on Vegas loot.")
RULE_INT(Vegas, RaidTargetNotCountAsRaidOne, 201074, "NPC ID of a raid target that will not count for Raid rolls on Vegas loot.")
RULE_INT(Vegas, RaidTargetNotCountAsRaidThree, 1, "NPC ID of a raid target that will not count for Raid rolls on Vegas loot.")
RULE_INT(Vegas, RaidTargetNotCountAsRaidTwo, 1, "NPC ID of a raid target that will not count for Raid rolls on Vegas loot.")
RULE_REAL(Vegas, RaidTargetRollMultiplier, .5, ".5 Default. Multiplier for raid rolls to hit (.5 = 50% of max, so 2x chance) 1-10 is normal, .5 would be a 1-5.")
RULE_INT(Vegas, RaidTargetTierOneRaidRollsCount, 3, "3 Default. Number of Tier 1 Raid Target gets for Raid Vegas rolls.")
RULE_REAL(Vegas, RaidTargetTierOneThreshold, 1131570.0, "1131570.0 Default. Threshold where a raid target enters Tier 1 status for Raid Rolls.")
RULE_INT(Vegas, RaidTargetTierTwoRaidRollsCount, 4, "4 Default. Number of Tier 2 Raid Target gets for Raid Vegas rolls.")
RULE_REAL(Vegas, RaidTargetTierTwoThreshold, 3000000.0, "3000000.0 Default. Threshold where a raid target enters Tier 2 status for Raid Rolls.")
RULE_INT(Vegas, RaidTargetTierThreeRaidRollsCount, 5, "5 Default. Number of Tier 3 Vegas rolls a raid target gets.")
RULE_REAL(Vegas, RaidTargetTierThreeThreshold, 4589610, "4589610.0 Default. Threshold where a raid target enters Tier 3 status for Raid Rolls.")
RULE_INT(Vegas, RaidTargetTierFourRaidRollsCount, 6, "6 Default. Number of Tier 4 Vegas rolls a raid target gets.")
RULE_REAL(Vegas, RaidTargetTierFourThreshold, 7189610, "7189610.0 Default. Threshold where a raid target enters Tier 4 status for Raid Rolls.")
RULE_INT(Vegas, RaidTargetTierFiveRaidRollsCount, 8, "8 Default. Number of Tier 5 Vegas rolls a raid target gets.")
RULE_REAL(Vegas, RaidTargetTierFiveThreshold, 10589610, "10589610.0 Default. Threshold where a raid target enters Tier 5 status for Raid Rolls.")
RULE_INT(Vegas, RaidVegasRollUpperLimit, 10, "10 Default. Raid Mob Maximum Roll for Vegas Rolls, 1-10 is a 10% chance.")
RULE_REAL(Vegas, RandomDropMultiplier, 1.00, "1.00 Default. Multiplier for Random Vegas drops.")
RULE_INT(Vegas, NormalTargetRaidVegasRollUpperLimit, 50, "50 Default. Normal Mob Maximum Roll for Raid Vegas Rolls, 1-50 is a 2% chance.")
RULE_INT(Vegas, RareTargetRaidVegasRollUpperLimit, 25, "26 Default. Rare Mob Maximum Roll for Raid Vegas Rolls, 1-26 is a 5% chance.")
RULE_INT(Vegas, RaidTargetRaidVegasRollUpperLimit, 5, "5 Default. Raid Mob Maximum Roll for Raid Vegas Rolls, 1-5 is a 20% chance.")
...
RULE_INT(Vegas, RareBonusVegasRollCount, 1, "1 Default. Count of Bonus Vegas Rolls for rare targets.")
RULE_INT(Vegas, RareBonusVegasRollUpperLimit, 20, "20 Default. Maximum Roll for Rare target Bonus Vegas Rolls, 1-4 is a 5% chance.")
RULE_REAL(Vegas, RareMaxDifficultyBonusMultiplier, 2.5, "2.5 Default. Max Bonus Difficutly multiplier for Rare Spawns.")
RULE_REAL(Vegas, RareMaxDifficultyMultiplier, 1.35, "1.35 Default. Max Difficutly multiplier for Rare Spawns.")
RULE_REAL(Vegas, RareMinDifficultyBonusMultiplier, 1.25, "1.25 Default. Min Bonus Difficutly multiplier for Rare Spawns.")
RULE_REAL(Vegas, RareMinDifficultyMultiplier, .6, ".6 Default. Min Difficutly multiplier for Rare Spawns.")
RULE_REAL(Vegas, RareTargetBonusRollMultiplier, 1, "1 Default. Multiplier for bonus rare target rolls to hit (.75 = 75% of max, so 2x chance) 1-20 is normal, .75 would be a 1-15.")
RULE_REAL(Vegas, RareTargetRaidRollMultiplier, 1, "1 Default. Multiplier for rare target bonus rolls to hit (1 = 100% of max, so no reduced chance) 1-4 is normal.")
RULE_INT(Vegas, RareTargetEpicTokenRollCount, 1, "1 Default. Roll counts for an Epic Token on Rare Targets.")
RULE_REAL(Vegas, RareTargetRollMultiplier, .75, ".75 Default. Multiplier for rare target rolls to hit (.75 = 75% of max, so 2x chance) 1-10 is normal, .75 would be a 1-7.5.")
RULE_INT(Vegas, RareTargetRollsCount, 2, "2 Default. Number of Normal Vegas rolls a rare spawn gets.")
RULE_INT(Vegas, RareVegasRollUpperLimit, 10, "10 Default. Rare Mob Maximum Roll for Vegas Rolls, 1-10 is a 10% chance.")
RULE_BOOL(Vegas, RequireLoottableForVegasLoot, true, "True Default. Requires an NPC to have a loottable if set to true.")
RULE_REAL(Vegas, ShardBonusLootMultiplier, 3.00, "3.00 Default. Multiplier for Shards on bonus drops.")
RULE_REAL(Vegas, ShardHotZoneMultiplier, 1.50, "1.50 Default. Hot Zone multiplier for Shard drops.")
RULE_INT(Vegas, ShardItemID, 550002, "550002 Default. Item ID for Shards.")
RULE_REAL(Vegas, ShardMultiplier, 1.00, "1.00 Default. Multiplier for Shard drops.")
RULE_INT(Vegas, ShardRollUpperLimit, 3, "3 Default. Upper limit for Shard rolls.")
RULE_INT(Vegas, NormalTargetShardDropCap, 200, "200 Default. Max drop count for Normal Targets.")
RULE_INT(Vegas, RareTargetShardDropCap, 300, "300 Default. Max drop count for Rare Targets.")
RULE_INT(Vegas, RaidTargetShardDropCap, 1000, "1000 Default. Max drop count for Raid Targets.")
RULE_INT(Vegas, NormalTargetBonusShardDropCap, 300, "300 Default. Max bonus drop count for Normal Targets.")
RULE_INT(Vegas, RareTargetBonusShardDropCap, 500, "500 Default. Max bonus drop count for Rare Targets.")
RULE_INT(Vegas, RaidTargetBonusShardDropCap, 2000, "2000 Default. Max bonus drop count for Raid Targets.")
RULE_REAL(Vegas, ShardHotZoneCapMultiplier, 1.25, "1.25 Default. Multiplier for the amount Hot Zones can go over the cap.")
...
RULE_REAL(Vegas, ValueToCapBonusRollMinAt, 249801, "249801 Default. Difficulty bonus roll minimum gets capped if over minimum.")
RULE_INT(Vegas, VegasBagLootDropIDIncrement, 100, "100 Default. Incrememnt gap between Lootdrop ID for Vegas Bags.")
RULE_INT(Vegas, VegasBagMaxLootDropID, 320600, "310700 Default. Max Lootdrop ID for Vegas Bags.")
RULE_INT(Vegas, VegasBagMinLootDropID, 320000, "310000 Default. Min Lootdrop ID for Vegas Bags.")
RULE_INT(Vegas, VegasBagRollCount, 1, "1 Default. Number of rolls of Vegas Bag Drops.")
RULE_INT(Vegas, VegasBagRollMax, 500, "500 Default. Maximum Roll for Vegas Bag Rolls, 1-250 is a .4% chance.")
RULE_INT(Vegas, VegasBagTierFiveLootDropID, 320400, "320400 Default. LootdropID For Tier 5 Bags.")
RULE_INT(Vegas, VegasBagTierFiveMaxLevel, 55, "55 Default. Maximum level for Tier 5 Bags.")
RULE_INT(Vegas, VegasBagTierFiveMinLevel, 46, "46 Default. Minimum level for Tier 5 Bags.")
RULE_INT(Vegas, VegasBagTierFourLootDropID, 320300, "320300 Default. LootdropID For Tier 4 Bags.")
RULE_INT(Vegas, VegasBagTierFourMaxLevel, 45, "45 Default. Maximum level for Tier 4 Bags.")
RULE_INT(Vegas, VegasBagTierFourMinLevel, 36, "36 Default. Minimum level for Tier 4 Bags.")
RULE_INT(Vegas, VegasBagTierOneLootDropID, 320000, "320000 Default. LootdropID For Tier 1 Bags.")
RULE_INT(Vegas, VegasBagTierOneMaxLevel, 10, "10 Default. Maximum level for Tier 1 Bags.")
RULE_INT(Vegas, VegasBagTierOneMinLevel, 1, "1 Default. Minimum level for Tier 1 Bags.")
RULE_INT(Vegas, VegasBagTierSevenLootDropID, 320600, "320600 Default. LootdropID For Tier 7 Bags.")
RULE_INT(Vegas, VegasBagTierSevenMaxLevel, 99, "99 Default. Maximum level for Tier 7 Bags.")
RULE_INT(Vegas, VegasBagTierSevenMinLevel, 63, "63 Default. Minimum level for Tier 7 Bags.")
RULE_INT(Vegas, VegasBagTierSixLootDropID, 320500, "320500 Default. LootdropID For Tier 6 Bags.")
RULE_INT(Vegas, VegasBagTierSixMaxLevel, 62, "62 Default. Maximum level for Tier 6 Bags.")
RULE_INT(Vegas, VegasBagTierSixMinLevel, 56, "56 Default. Minimum level for Tier 6 Bags.")
RULE_INT(Vegas, VegasBagTierThreeLootDropID, 320200, "320200 Default. LootdropID For Tier 3 Bags.")
RULE_INT(Vegas, VegasBagTierThreeMaxLevel, 35, "35 Default. Maximum level for Tier 3 Bags.")
RULE_INT(Vegas, VegasBagTierThreeMinLevel, 26, "26 Default. Minimum level for Tier 3 Bags.")
RULE_INT(Vegas, VegasBagTierTwoLootDropID, 320100, "320100 Default. LootdropID For Tier 2 Bags.")
RULE_INT(Vegas, VegasBagTierTwoMaxLevel, 25, "25 Default. Maximum level for Tier 2 Bags.")
RULE_INT(Vegas, VegasBagTierTwoMinLevel, 11, "11 Default. Minimum level for Tier 2 Bags.")
RULE_INT(Vegas, VegasBridleLootDropIDIncrement, 100, "100 Default. Incrememnt gap between Lootdrop ID for Vegas Bridles.")
RULE_INT(Vegas, VegasBridleMaxLootDropID, 330300, "310700 Default. Max Lootdrop ID for Vegas Bridles.")
RULE_INT(Vegas, VegasBridleMinLootDropID, 330000, "310000 Default. Min Lootdrop ID for Vegas Bridles.")
RULE_INT(Vegas, VegasBridleRollCount, 1, "1 Default. Number of rolls of Vegas Bridle Drops.")
RULE_INT(Vegas, VegasBridleRollMax, 2500, "2500 Default. Maximum Roll for Vegas Bridle Rolls, 1-2500 is a .04% chance.")
RULE_INT(Vegas, VegasBridleTierFourLootDropID, 330300, "330300 Default. LootdropID For Tier 4 Bridles.")
RULE_INT(Vegas, VegasBridleTierFourMaxLevel, 99, "99 Default. Maximum level for Tier 4 Bridles.")
RULE_INT(Vegas, VegasBridleTierFourMinLevel, 63, "63 Default. Minimum level for Tier 4 Bridles.")
RULE_INT(Vegas, VegasBridleTierOneLootDropID, 330000, "330000 Default. LootdropID For Tier 1 Bridles.")
RULE_INT(Vegas, VegasBridleTierOneMaxLevel, 35, "35 Default. Maximum level for Tier 1 Bridles.")
RULE_INT(Vegas, VegasBridleTierOneMinLevel, 20, "20 Default. Minimum level for Tier 1 Bridles.")
RULE_INT(Vegas, VegasBridleTierThreeLootDropID, 330200, "330200 Default. LootdropID For Tier 3 Bridles.")
RULE_INT(Vegas, VegasBridleTierThreeMaxLevel, 62, "62 Default. Maximum level for Tier 3 Bridles.")
RULE_INT(Vegas, VegasBridleTierThreeMinLevel, 56, "56 Default. Minimum level for Tier 3 Bridles.")
RULE_INT(Vegas, VegasBridleTierTwoLootDropID, 330100, "330100 Default. LootdropID For Tier 2 Bridles.")
RULE_INT(Vegas, VegasBridleTierTwoMaxLevel, 55, "55 Default. Maximum level for Tier 2 Bridles.")
RULE_INT(Vegas, VegasBridleTierTwoMinLevel, 36, "36 Default. Minimum level for Tier 2 Bridles.")
RULE_INT(Vegas, VegasSpellRollCount, 1, "1 Default. Number of rolls of Vegas Spell Drops.")
RULE_INT(Vegas, VegasSpellRollMax, 100, "100 Default. Max Roll for Spell Drops.")
RULE_INT(Vegas, VegasSpellRollMaxHit, 100, "100 Default. Roll required to hit the Max spell level drop.")
RULE_INT(Vegas, VegasSpellRollMinHit, 95, "95 Default. Roll required to hit the min spell level drop.")
RULE_INT(Vegas, VegasSpellRollNormalHit, 97, "97 Default. Roll required to hit the normal spell level drop.")
RULE_INT(Vegas, VegasSpellTierEightBonusHighLootDropID, 0, "0 Default. BonusLootdropID for a max roll on Tier 8 Spells.")
RULE_INT(Vegas, VegasSpellTierEightBonusLowLootDropID, 0, "0 Default. BonusLootdropID for a min roll on Tier 8 Spells.")
RULE_INT(Vegas, VegasSpellTierEightLootDropID, 310700, "310700 Default. LootdropID For Tier 8 Spells.")
RULE_INT(Vegas, VegasSpellTierEightMaxLevel, 99, "99 Default. Maximum level for Tier 8 Spells.")
RULE_INT(Vegas, VegasSpellTierEightMinLevel, 57, "57 Default. Minimum level for Tier 8 Spells.")
RULE_INT(Vegas, VegasSpellTierFiveBonusHighLootDropID, 310500, "310500 Default. BonusLootdropID for a max roll on Tier 5 Spells.")
RULE_INT(Vegas, VegasSpellTierFiveBonusLowLootDropID, 310300, "310300 Default. BonusLootdropID for a min roll on Tier 5 Spells.")
RULE_INT(Vegas, VegasSpellTierFiveLootDropID, 310400, "310400 Default. LootdropID For Tier 5 Spells.")
RULE_INT(Vegas, VegasSpellTierFiveMaxLevel, 46, "46 Default. Maximum level for Tier 5 Spells.")
RULE_INT(Vegas, VegasSpellTierFiveMinLevel, 41, "41 Default. Minimum level for Tier 5 Spells.")
RULE_INT(Vegas, VegasSpellTierFourBonusHighLootDropID, 310400, "310400 Default. BonusLootdropID for a max roll on Tier 5 Spells.")
RULE_INT(Vegas, VegasSpellTierFourBonusLowLootDropID, 310200, "310200 Default. BonusLootdropID for a min roll on Tier 5 Spells.")
RULE_INT(Vegas, VegasSpellTierFourLootDropID, 310300, "310300 Default. LootdropID For Tier 4 Spells.")
RULE_INT(Vegas, VegasSpellTierFourMaxLevel, 40, "40 Default. Maximum level for Tier 4 Spells.")
RULE_INT(Vegas, VegasSpellTierFourMinLevel, 31, "31 Default. Minimum level for Tier 4 Spells.")
RULE_INT(Vegas, VegasSpellTierOneBonusHighLootDropID, 310100, "310100 Default. BonusLootdropID for a max roll on Tier 1 Spells.")
RULE_INT(Vegas, VegasSpellTierOneBonusLowLootDropID, 0, "0 Default. BonusLootdropID for a min roll on Tier 1 Spells.")
RULE_INT(Vegas, VegasSpellTierOneLootDropID, 310000, "310000 Default. LootdropID For Tier 1 Spells.")
RULE_INT(Vegas, VegasSpellTierOneMaxLevel, 10, "10 Default. Maximum level for Tier 1 Spells.")
RULE_INT(Vegas, VegasSpellTierOneMinLevel, 1, "1 Default. Minimum level for Tier 1 Spells.")
RULE_INT(Vegas, VegasSpellTierSevenBonusHighLootDropID, 310700, "310700 Default. BonusLootdropID for a max roll on Tier 7 Spells.")
RULE_INT(Vegas, VegasSpellTierSevenBonusLowLootDropID, 310500, "310500 Default. BonusLootdropID for a min roll on Tier 7 Spells.")
RULE_INT(Vegas, VegasSpellTierSevenLootDropID, 310600, "310600 Default. LootdropID For Tier 7 Spells.")
RULE_INT(Vegas, VegasSpellTierSevenMaxLevel, 56, "56 Default. Maximum level for Tier 7 Spells.")
RULE_INT(Vegas, VegasSpellTierSevenMinLevel, 53, "53 Default. Minimum level for Tier 7 Spells.")
RULE_INT(Vegas, VegasSpellTierSixBonusHighLootDropID, 310600, "310600 Default. BonusLootdropID for a max roll on Tier 6 Spells.")
RULE_INT(Vegas, VegasSpellTierSixBonusLowLootDropID, 310400, "310400 Default. BonusLootdropID for a min roll on Tier 6 Spells.")
RULE_INT(Vegas, VegasSpellTierSixLootDropID, 310500, "310500 Default. LootdropID For Tier 6 Spells.")
RULE_INT(Vegas, VegasSpellTierSixMaxLevel, 52, "52 Default. Maximum level for Tier 6 Spells.")
RULE_INT(Vegas, VegasSpellTierSixMinLevel, 47, "47 Default. Minimum level for Tier 6 Spells.")
RULE_INT(Vegas, VegasSpellTierThreeBonusHighLootDropID, 310300, "310300 Default. BonusLootdropID for a max roll on Tier 3 Spells.")
RULE_INT(Vegas, VegasSpellTierThreeBonusLowLootDropID, 310100, "310100 Default. BonusLootdropID for a min roll on Tier 3 Spells.")
RULE_INT(Vegas, VegasSpellTierThreeLootDropID, 310200, "310200 Default. LootdropID For Tier 3 Spells.")
RULE_INT(Vegas, VegasSpellTierThreeMaxLevel, 30, "30 Default. Maximum level for Tier 3 Spells.")
RULE_INT(Vegas, VegasSpellTierThreeMinLevel, 21, "21 Default. Minimum level for Tier 3 Spells.")
RULE_INT(Vegas, VegasSpellTierTwoBonusHighLootDropID, 310200, "310200 Default. BonusLootdropID for a max roll on Tier 2 Spells.")
RULE_INT(Vegas, VegasSpellTierTwoBonusLowLootDropID, 310000, "310000 Default. BonusLootdropID for a min roll on Tier 2 Spells.")
RULE_INT(Vegas, VegasSpellTierTwoLootDropID, 310100, "310100 Default. LootdropID For Tier 2 Spells.")
RULE_INT(Vegas, VegasSpellTierTwoMaxLevel, 20, "20 Default. Maximum level for Tier 2 Spells.")
RULE_INT(Vegas, VegasSpellTierTwoMinLevel, 11, "11 Default. Minimum level for Tier 2 Spells.")
RULE_INT(Vegas, VeliousZoneNPCIDMax, 224999, "224999 Default. Maximum NPC ID to select from for Vegas items for Velious Zone drops.")
RULE_INT(Vegas, VeliousZoneNPCIDMin, 78000, "78000 Default. Minimum NPC ID to select from for Vegas items for Velious Zone drops.")
RULE_REAL(Vegas, MinDifficultyCap, 2973500, "2973500 Default. Maximum Min Difficulty can be.")
RULE_REAL(Vegas, MaxDifficultyCap, 11894000, "11894000 Default. Maximum Max Difficulty can be.")
RULE_REAL(Vegas, MinBonusDifficultyCap, 5947000, "5947000 Default. Maximum Min Bonus Difficulty can be.")
RULE_REAL(Vegas, MaxBonusDifficultyCap, 11894000, "11894000 Default. Maximum Max Bonus Difficulty can be.")
RULE_INT(Vegas, SpecialEventZoneOne, 0, "0 Default. Special Zones to pass zone ID checks for Vegas loot.")
RULE_INT(Vegas, SpecialEventZoneOneVersion, 0, "0 Default. Special Zone version to pass zone ID checks for Vegas loot.")
RULE_INT(Vegas, SpecialEventZoneTwo, 0, "0 Default. Special Zones to pass zone ID checks for Vegas loot.")
RULE_INT(Vegas, SpecialEventZoneTwoVersion, 0, "0 Default. Special Zone version to pass zone ID checks for Vegas loot.")
RULE_INT(Vegas, SpecialEventZoneThree, 0, "0 Default. Special Zones to pass zone ID checks for Vegas loot.")
RULE_INT(Vegas, SpecialEventZoneThreeVersion, 0, "0 Default. Special Zone version to pass zone ID checks for Vegas loot.")
RULE_INT(Vegas, SpecialEventZoneOneIDMax, 0, "0 Default. Max Zone ID for SpecialEventZoneOne.")
RULE_INT(Vegas, SpecialEventZoneTwoIDMax, 0, "0 Default. Max Zone ID for SpecialEventZoneTwo.")
RULE_INT(Vegas, SpecialEventZoneThreeIDMax, 0, "0 Default. Max Zone ID for SpecialEventZoneThree.")
RULE_INT(Vegas, SpecialEventZoneOneIDMin, 0, "0 Default. Min Zone ID for SpecialEventZoneOne.")
RULE_INT(Vegas, SpecialEventZoneTwoIDMin, 0, "0 Default. Min Zone ID for SpecialEventZoneTwo.")
RULE_INT(Vegas, SpecialEventZoneThreeIDMin, 0, "0 Default. Min Zone ID for SpecialEventZoneThree.")
RULE_INT(Vegas, SpecialZoneScalingOne, 0, "0 Default. Special Zones for advanced scaling.")
RULE_INT(Vegas, SpecialZoneScalingTwo, 0, "0 Default. Special Zones for advanced scaling.")
RULE_INT(Vegas, SpecialZoneScalingThree, 0, "0 Default. Special Zones for advanced scaling.")
RULE_REAL(Vegas, SpecialZoneScalingOneCommonMaxHP, 0, "0 Default. Special Zone One for advanced scaling for MaxHP.")
RULE_REAL(Vegas, SpecialZoneScalingOneCommonMinHit, 0, "0 Default. Special Zones One for advanced scaling for MinHit.")
RULE_REAL(Vegas, SpecialZoneScalingOneCommonMaxHit, 0, "0 Default. Special Zones One for advanced scaling for MaxHit.")
RULE_REAL(Vegas, SpecialZoneScalingOneRareMaxHP, 0, "0 Default. Special Zone One for advanced scaling for MaxHP.")
RULE_REAL(Vegas, SpecialZoneScalingOneRareMinHit, 0, "0 Default. Special Zones One for advanced scaling for MinHit.")
RULE_REAL(Vegas, SpecialZoneScalingOneRareMaxHit, 0, "0 Default. Special Zones One for advanced scaling for MaxHit.")
RULE_REAL(Vegas, SpecialZoneScalingOneRaidMaxHP, 0, "0 Default. Special Zone One for advanced scaling for MaxHP.")
RULE_REAL(Vegas, SpecialZoneScalingOneRaidMinHit, 0, "0 Default. Special Zones One for advanced scaling for MinHit.")
RULE_REAL(Vegas, SpecialZoneScalingOneRaidMaxHit, 0, "0 Default. Special Zones One for advanced scaling for MaxHit.")
RULE_REAL(Vegas, SpecialZoneScalingTwoCommonMaxHP, 0, "0 Default. Special Zone Two for advanced scaling for MaxHP.")
RULE_REAL(Vegas, SpecialZoneScalingTwoCommonMinHit, 0, "0 Default. Special Zones Two for advanced scaling for MinHit.")
RULE_REAL(Vegas, SpecialZoneScalingTwoCommonMaxHit, 0, "0 Default. Special Zones Two for advanced scaling for MaxHit.")
RULE_REAL(Vegas, SpecialZoneScalingTwoRareMaxHP, 0, "0 Default. Special Zone Two for advanced scaling for MaxHP.")
RULE_REAL(Vegas, SpecialZoneScalingTwoRareMinHit, 0, "0 Default. Special Zones Two for advanced scaling for MinHit.")
RULE_REAL(Vegas, SpecialZoneScalingTwoRareMaxHit, 0, "0 Default. Special Zones Two for advanced scaling for MaxHit.")
RULE_REAL(Vegas, SpecialZoneScalingTwoRaidMaxHP, 0, "0 Default. Special Zone Two for advanced scaling for MaxHP.")
RULE_REAL(Vegas, SpecialZoneScalingTwoRaidMinHit, 0, "0 Default. Special Zones Two for advanced scaling for MinHit.")
RULE_REAL(Vegas, SpecialZoneScalingTwoRaidMaxHit, 0, "0 Default. Special Zones Two for advanced scaling for MaxHit.")
RULE_REAL(Vegas, SpecialZoneScalingThreeCommonMaxHP, 0, "0 Default. Special Zone Three for advanced scaling for MaxHP.")
RULE_REAL(Vegas, SpecialZoneScalingThreeCommonMinHit, 0, "0 Default. Special Zones Three for advanced scaling for MinHit.")
RULE_REAL(Vegas, SpecialZoneScalingThreeCommonMaxHit, 0, "0 Default. Special Zones Three for advanced scaling for MaxHit.")
RULE_REAL(Vegas, SpecialZoneScalingThreeRareMaxHP, 0, "0 Default. Special Zone Three for advanced scaling for MaxHP.")
RULE_REAL(Vegas, SpecialZoneScalingThreeRareMinHit, 0, "0 Default. Special Zones Three for advanced scaling for MinHit.")
RULE_REAL(Vegas, SpecialZoneScalingThreeRareMaxHit, 0, "0 Default. Special Zones Three for advanced scaling for MaxHit.")
RULE_REAL(Vegas, SpecialZoneScalingThreeRaidMaxHP, 0, "0 Default. Special Zone Three for advanced scaling for MaxHP.")
RULE_REAL(Vegas, SpecialZoneScalingThreeRaidMinHit, 0, "0 Default. Special Zones Three for advanced scaling for MinHit.")
RULE_REAL(Vegas, SpecialZoneScalingThreeRaidMaxHit, 0, "0 Default. Special Zones Three for advanced scaling for MaxHit.")
RULE_INT(Vegas, GuaranteedNormalDropOne, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedNormalDropTwo, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedNormalDropThree, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedNormalDropFour, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedNormalDropFive, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedBonusDropOne, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedBonusDropTwo, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedBonusDropThree, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedBonusDropFour, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedBonusDropFive, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedRaidDropOne, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
RULE_INT(Vegas, GuaranteedRaidDropTwo, 0, "ID of an NPC for a guaranteed Normal Vegas Drop.")
...
RULE_INT(CharChange, LockoutDuration, 30, "Number of days until the command can be used again, default 30")
