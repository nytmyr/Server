...
RULE_INT(Bots, NukeResistLimit, 150, "150 Default. This is the nuke resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, RootResistLimit, 150, "150 Default. This is the root resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, InCombatBuffResistLimit, 150, "150 Default. This is the in-combat buff resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, LifetapResistLimit, 150, "150 Default. This is the lifetap resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, SnareResistLimit, 150, "150 Default. This is the snare resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, DoTResistLimit, 150, "150 Default. This is the dot resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, DispelResistLimit, 150, "150 Default. This is the dispel resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, CharmResistLimit, 150, "150 Default. This is the charm resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, SlowResistLimit, 150, "150 Default. This is the slow resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, DebuffResistLimit, 150, "150 Default. This is the debuff resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, MezResistLimit, 150, "150 Default. This is the mez resist cap where bots will refuse to cast due to a high resist chance.")
RULE_INT(Bots, HateReduxResistLimit, 150, "150 Default. This is the hate redux resist cap where bots will refuse to cast due to a high resist chance.")
...
RULE_INT(Bots, PercentChanceToCastNuke, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastHeal, 90, "The chance for a bot to attempt to cast the given spell type. Default 90%.")
RULE_INT(Bots, PercentChanceToCastRoot, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastBuff, 100, "The chance for a bot to attempt to cast the given spell type. Default 100%.")
RULE_INT(Bots, PercentChanceToCastEscape, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastPet, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastLifetap, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastSnare, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastDOT, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastDispel, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastInCombatBuff, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastMez, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastCharm, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastSlow, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastDebuff, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastCure, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastResurrect, 100, "The chance for a bot to attempt to cast the given spell type. Default 100%.")
RULE_INT(Bots, PercentChanceToCastHateRedux, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastInCombatBuffSong, 75, "The chance for a bot to attempt to cast the given spell type. Default 75%.")
RULE_INT(Bots, PercentChanceToCastOutOfCombatBuffSong, 100, "The chance for a bot to attempt to cast the given spell type. Default 100%.")
RULE_INT(Bots, PercentChanceToCastPreCombatBuff, 100, "The chance for a bot to attempt to cast the given spell type. Default 100%.")
RULE_INT(Bots, PercentChanceToCastPreCombatBuffSong, 100, "The chance for a bot to attempt to cast the given spell type. Default 100%.")
...
RULE_INT(Bots, MinDelayBetweenOutCombatCastAttempts, 200, "The minimum delay in milliseconds between cast attempts while out-of-combat. This is rolled between the min and max. Default 200ms.")
...
RULE_INT(Bots, MinDelayBetweenHealCastAttempts, 500, "The minimum delay in milliseconds between heal cast attempts. This is rolled between the min and max. Default 500ms.")
RULE_INT(Bots, MaxDelayBetweenHealCastAttempts, 1250, "The maximum delay in milliseconds between heal cast attempts. This is rolled between the min and max. Default 1250ms.")
...
RULE_INT(Bots, MinGroupHealTargets, 3, "Minimum number of targets in valid range that require a group heal for one to be chosen to cast. Default 3.")
RULE_CATEGORY_END()
