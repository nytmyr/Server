...
{ 
	...
	constexpr uint16	PetGroupHeals				= 50;
	constexpr uint16	PetGroupCompleteHeals		= 51;
	constexpr uint16	PetGroupHoTHeals			= 52;
	constexpr uint16	PetHoTHeals					= 53;
...
bool IS_CLIENT_SPELL_TYPE(uint16 spellType);
bool IS_HEAL_SPELL_TYPE(uint16 spellType);
