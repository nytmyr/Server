...
public:
	...
	)
	{
		...
		if (results.RowCount() == 1) {
			...
			e.hold_cures					= static_cast<uint8_t>(strtoul(row[52], nullptr, 10));
			e.hold_dots						= static_cast<uint8_t>(strtoul(row[53], nullptr, 10));
			e.hold_debuffs					= static_cast<uint8_t>(strtoul(row[54], nullptr, 10));
			e.hold_dispels					= static_cast<uint8_t>(strtoul(row[55], nullptr, 10));
			e.hold_escapes					= static_cast<uint8_t>(strtoul(row[56], nullptr, 10));
			e.hold_hateredux				= static_cast<uint8_t>(strtoul(row[57], nullptr, 10));
			e.hold_heals					= static_cast<uint8_t>(strtoul(row[58], nullptr, 10));
			e.hold_incombatbuffs			= static_cast<uint8_t>(strtoul(row[59], nullptr, 10));
			e.hold_incombatbuffsongs		= static_cast<uint8_t>(strtoul(row[60], nullptr, 10));
			e.hold_lifetaps					= static_cast<uint8_t>(strtoul(row[61], nullptr, 10));
			e.hold_mez						= static_cast<uint8_t>(strtoul(row[62], nullptr, 10));
			e.hold_nukes					= static_cast<uint8_t>(strtoul(row[63], nullptr, 10));
			e.hold_outofcombatbuffsongs		= static_cast<uint8_t>(strtoul(row[64], nullptr, 10));
			e.hold_pet_buffs				= static_cast<uint8_t>(strtoul(row[65], nullptr, 10));
			e.hold_pet_heals				= static_cast<uint8_t>(strtoul(row[66], nullptr, 10));
			e.hold_pets						= static_cast<uint8_t>(strtoul(row[67], nullptr, 10));
			e.hold_precombatbuffs			= static_cast<uint8_t>(strtoul(row[68], nullptr, 10));
			e.hold_precombatbuffsongs		= static_cast<uint8_t>(strtoul(row[69], nullptr, 10));
			e.hold_roots					= static_cast<uint8_t>(strtoul(row[70], nullptr, 10));
			e.hold_slows					= static_cast<uint8_t>(strtoul(row[71], nullptr, 10));
			e.hold_snares					= static_cast<uint8_t>(strtoul(row[72], nullptr, 10));
			e.auto_ds						= static_cast<uint8_t>(strtoul(row[73], nullptr, 10));
			e.auto_resist					= static_cast<uint8_t>(strtoul(row[74], nullptr, 10));
			e.behind_mob					= static_cast<uint8_t>(strtoul(row[75], nullptr, 10));
			e.caster_range					= static_cast<uint32_t>(strtoul(row[76], nullptr, 10));
			e.buff_delay					= static_cast<uint32_t>(strtoul(row[77], nullptr, 10));
			e.complete_heal_delay			= static_cast<uint32_t>(strtoul(row[78], nullptr, 10));
			e.cure_delay					= static_cast<uint32_t>(strtoul(row[79], nullptr, 10));
			e.debuff_delay					= static_cast<uint32_t>(strtoul(row[80], nullptr, 10));
			e.dispel_delay					= static_cast<uint32_t>(strtoul(row[81], nullptr, 10));
			e.dot_delay						= static_cast<uint32_t>(strtoul(row[82], nullptr, 10));
			e.escape_delay					= static_cast<uint32_t>(strtoul(row[83], nullptr, 10));
			e.fast_heal_delay				= static_cast<uint32_t>(strtoul(row[84], nullptr, 10));
			e.hate_redux_delay				= static_cast<uint32_t>(strtoul(row[85], nullptr, 10));
			e.heal_delay					= static_cast<uint32_t>(strtoul(row[86], nullptr, 10));
			e.hot_heal_delay				= static_cast<uint32_t>(strtoul(row[87], nullptr, 10));
			e.incombatbuff_delay			= static_cast<uint32_t>(strtoul(row[88], nullptr, 10));
			e.lifetap_delay					= static_cast<uint32_t>(strtoul(row[89], nullptr, 10));
			e.mez_delay						= static_cast<uint32_t>(strtoul(row[90], nullptr, 10));
			e.nuke_delay					= static_cast<uint32_t>(strtoul(row[91], nullptr, 10));
			e.root_delay					= static_cast<uint32_t>(strtoul(row[92], nullptr, 10));
			e.slow_delay					= static_cast<uint32_t>(strtoul(row[93], nullptr, 10));
			e.snare_delay					= static_cast<uint32_t>(strtoul(row[94], nullptr, 10));
			e.buff_threshold				= static_cast<uint8_t>(strtoul(row[95], nullptr, 10));
			e.complete_heal_threshold		= static_cast<uint8_t>(strtoul(row[96], nullptr, 10));
			e.cure_threshold				= static_cast<uint8_t>(strtoul(row[97], nullptr, 10));
			e.debuff_threshold				= static_cast<uint8_t>(strtoul(row[98], nullptr, 10));
			e.dispel_threshold				= static_cast<uint8_t>(strtoul(row[99], nullptr, 10));
			e.dot_threshold					= static_cast<uint8_t>(strtoul(row[100], nullptr, 10));
			e.escape_threshold				= static_cast<uint8_t>(strtoul(row[101], nullptr, 10));
			e.fast_heal_threshold			= static_cast<uint8_t>(strtoul(row[102], nullptr, 10));
			e.hate_redux_threshold			= static_cast<uint8_t>(strtoul(row[103], nullptr, 10));
			e.heal_threshold				= static_cast<uint8_t>(strtoul(row[104], nullptr, 10));
			e.hot_heal_threshold			= static_cast<uint8_t>(strtoul(row[105], nullptr, 10));
			e.incombatbuff_threshold		= static_cast<uint8_t>(strtoul(row[106], nullptr, 10));
			e.lifetap_threshold				= static_cast<uint8_t>(strtoul(row[107], nullptr, 10));
			e.mez_threshold					= static_cast<uint8_t>(strtoul(row[108], nullptr, 10));
			e.nuke_threshold				= static_cast<uint8_t>(strtoul(row[109], nullptr, 10));
			e.root_threshold				= static_cast<uint8_t>(strtoul(row[110], nullptr, 10));
			e.slow_threshold				= static_cast<uint8_t>(strtoul(row[111], nullptr, 10));
			e.snare_threshold				= static_cast<uint8_t>(strtoul(row[112], nullptr, 10));
			e.buff_min_threshold			= static_cast<uint8_t>(strtoul(row[113], nullptr, 10));
			e.cure_min_threshold			= static_cast<uint8_t>(strtoul(row[114], nullptr, 10));
			e.debuff_min_threshold			= static_cast<uint8_t>(strtoul(row[115], nullptr, 10));
			e.dispel_min_threshold			= static_cast<uint8_t>(strtoul(row[116], nullptr, 10));
			e.dot_min_threshold				= static_cast<uint8_t>(strtoul(row[117], nullptr, 10));
			e.escape_min_threshold			= static_cast<uint8_t>(strtoul(row[118], nullptr, 10));
			e.hate_redux_min_threshold		= static_cast<uint8_t>(strtoul(row[119], nullptr, 10));
			e.incombatbuff_min_threshold	= static_cast<uint8_t>(strtoul(row[120], nullptr, 10));
			e.lifetap_min_threshold			= static_cast<uint8_t>(strtoul(row[121], nullptr, 10));
			e.mez_min_threshold				= static_cast<uint8_t>(strtoul(row[122], nullptr, 10));
			e.nuke_min_threshold			= static_cast<uint8_t>(strtoul(row[123], nullptr, 10));
			e.root_min_threshold			= static_cast<uint8_t>(strtoul(row[124], nullptr, 10));
			e.slow_min_threshold			= static_cast<uint8_t>(strtoul(row[125], nullptr, 10));
			e.snare_min_threshold			= static_cast<uint8_t>(strtoul(row[126], nullptr, 10));
	...
	)
	{
		...
		v.push_back(columns[52] + " = " + std::to_string(e.hold_cures));
		v.push_back(columns[53] + " = " + std::to_string(e.hold_dots));
		v.push_back(columns[54] + " = " + std::to_string(e.hold_debuffs));
		v.push_back(columns[55] + " = " + std::to_string(e.hold_dispels));
		v.push_back(columns[56] + " = " + std::to_string(e.hold_escapes));
		v.push_back(columns[57] + " = " + std::to_string(e.hold_hateredux));
		v.push_back(columns[58] + " = " + std::to_string(e.hold_heals));
		v.push_back(columns[59] + " = " + std::to_string(e.hold_incombatbuffs));
		v.push_back(columns[60] + " = " + std::to_string(e.hold_incombatbuffsongs));
		v.push_back(columns[61] + " = " + std::to_string(e.hold_lifetaps));
		v.push_back(columns[62] + " = " + std::to_string(e.hold_mez));
		v.push_back(columns[63] + " = " + std::to_string(e.hold_nukes));
		v.push_back(columns[64] + " = " + std::to_string(e.hold_outofcombatbuffsongs));
		v.push_back(columns[65] + " = " + std::to_string(e.hold_pet_buffs));
		v.push_back(columns[66] + " = " + std::to_string(e.hold_pet_heals));
		v.push_back(columns[67] + " = " + std::to_string(e.hold_pets));
		v.push_back(columns[68] + " = " + std::to_string(e.hold_precombatbuffs));
		v.push_back(columns[69] + " = " + std::to_string(e.hold_precombatbuffsongs));
		v.push_back(columns[70] + " = " + std::to_string(e.hold_roots));
		v.push_back(columns[71] + " = " + std::to_string(e.hold_slows));
		v.push_back(columns[72] + " = " + std::to_string(e.hold_snares));
		v.push_back(columns[73] + " = " + std::to_string(e.auto_ds));
		v.push_back(columns[74] + " = " + std::to_string(e.auto_resist));
		v.push_back(columns[75] + " = " + std::to_string(e.behind_mob));
		v.push_back(columns[76] + " = " + std::to_string(e.caster_range));
		v.push_back(columns[77] + " = " + std::to_string(e.buff_delay));
		v.push_back(columns[78] + " = " + std::to_string(e.complete_heal_delay));
		v.push_back(columns[79] + " = " + std::to_string(e.cure_delay));
		v.push_back(columns[80] + " = " + std::to_string(e.debuff_delay));
		v.push_back(columns[81] + " = " + std::to_string(e.dispel_delay));
		v.push_back(columns[82] + " = " + std::to_string(e.dot_delay));
		v.push_back(columns[83] + " = " + std::to_string(e.escape_delay));
		v.push_back(columns[84] + " = " + std::to_string(e.fast_heal_delay));
		v.push_back(columns[85] + " = " + std::to_string(e.hate_redux_delay));
		v.push_back(columns[86] + " = " + std::to_string(e.heal_delay));
		v.push_back(columns[87] + " = " + std::to_string(e.hot_heal_delay));
		v.push_back(columns[88] + " = " + std::to_string(e.incombatbuff_delay));
		v.push_back(columns[89] + " = " + std::to_string(e.lifetap_delay));
		v.push_back(columns[90] + " = " + std::to_string(e.mez_delay));
		v.push_back(columns[91] + " = " + std::to_string(e.nuke_delay));
		v.push_back(columns[92] + " = " + std::to_string(e.root_delay));
		v.push_back(columns[93] + " = " + std::to_string(e.slow_delay));
		v.push_back(columns[94] + " = " + std::to_string(e.snare_delay));
		v.push_back(columns[95] + " = " + std::to_string(e.buff_threshold));
		v.push_back(columns[96] + " = " + std::to_string(e.complete_heal_threshold));
		v.push_back(columns[97] + " = " + std::to_string(e.cure_threshold));
		v.push_back(columns[98] + " = " + std::to_string(e.debuff_threshold));
		v.push_back(columns[99] + " = " + std::to_string(e.dispel_threshold));
		v.push_back(columns[100] + " = " + std::to_string(e.dot_threshold));
		v.push_back(columns[101] + " = " + std::to_string(e.escape_threshold));
		v.push_back(columns[102] + " = " + std::to_string(e.fast_heal_threshold));
		v.push_back(columns[103] + " = " + std::to_string(e.hate_redux_threshold));
		v.push_back(columns[104] + " = " + std::to_string(e.heal_threshold));
		v.push_back(columns[105] + " = " + std::to_string(e.hot_heal_threshold));
		v.push_back(columns[106] + " = " + std::to_string(e.incombatbuff_threshold));
		v.push_back(columns[107] + " = " + std::to_string(e.lifetap_threshold));
		v.push_back(columns[108] + " = " + std::to_string(e.mez_threshold));
		v.push_back(columns[109] + " = " + std::to_string(e.nuke_threshold));
		v.push_back(columns[110] + " = " + std::to_string(e.root_threshold));
		v.push_back(columns[111] + " = " + std::to_string(e.slow_threshold));
		v.push_back(columns[112] + " = " + std::to_string(e.snare_threshold));
		v.push_back(columns[113] + " = " + std::to_string(e.buff_min_threshold));
		v.push_back(columns[114] + " = " + std::to_string(e.cure_min_threshold));
		v.push_back(columns[115] + " = " + std::to_string(e.debuff_min_threshold));
		v.push_back(columns[116] + " = " + std::to_string(e.dispel_min_threshold));
		v.push_back(columns[117] + " = " + std::to_string(e.dot_min_threshold));
		v.push_back(columns[118] + " = " + std::to_string(e.escape_min_threshold));
		v.push_back(columns[119] + " = " + std::to_string(e.hate_redux_min_threshold));
		v.push_back(columns[120] + " = " + std::to_string(e.incombatbuff_min_threshold));
		v.push_back(columns[121] + " = " + std::to_string(e.lifetap_min_threshold));
		v.push_back(columns[122] + " = " + std::to_string(e.mez_min_threshold));
		v.push_back(columns[123] + " = " + std::to_string(e.nuke_min_threshold));
		v.push_back(columns[124] + " = " + std::to_string(e.root_min_threshold));
		v.push_back(columns[125] + " = " + std::to_string(e.slow_min_threshold));
		v.push_back(columns[126] + " = " + std::to_string(e.snare_min_threshold));
