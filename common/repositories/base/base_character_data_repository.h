...
public:
	...
	)
	{
		...
		v.push_back(columns[103] + " = " + std::to_string(e.fast_heal_threshold));
		v.push_back(columns[104] + " = " + std::to_string(e.heal_threshold));
		v.push_back(columns[105] + " = " + std::to_string(e.complete_heal_threshold));
		v.push_back(columns[106] + " = " + std::to_string(e.hot_heal_threshold));
		v.push_back(columns[107] + " = " + std::to_string(e.fast_heal_delay));
