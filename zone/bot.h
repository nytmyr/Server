...
public:
	...
	uint16 SetDefaultSpellTypeIdlePriority(uint16 spellType, uint8 botClass);
	uint16 SetDefaultSpellTypeEngagedPriority(uint16 spellType, uint8 botClass);
	uint16 SetDefaultSpellTypePursuePriority(uint16 spellType, uint8 botClass);
