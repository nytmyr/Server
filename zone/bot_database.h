...
public:
	...
	bool SaveHoldDS(const uint32 owner_id, const uint32 bot_id, const uint8 hold_value);
	...
	bool SaveHoldPetBuffs(const uint32 owner_id, const uint32 bot_id, const uint8 hold_value);
	bool SaveHoldPetHeals(const uint32 owner_id, const uint32 bot_id, const uint8 hold_value);
	...
	bool SaveHoldResists(const uint32 owner_id, const uint32 bot_id, const uint8 hold_value);
