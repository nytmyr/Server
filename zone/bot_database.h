...
public:
	...
	bool SaveHoldCures(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldDebuffs(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldDispels(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldDoTs(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldDS(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldEscapes(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldFastHeals(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldGroupHeals(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldHateRedux(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldHeals(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldHotHeals(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldInCombatBuffs(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldInCombatBuffSongs(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldLifetaps(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldLulls(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldMez(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldNukes(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldOutOfCombatBuffSongs(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldPetBuffs(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldPetHeals(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldPets(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldPreCombatBuffs(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldPreCombatBuffSongs(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldRegularHeals(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldResists(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldRez(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldRoots(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldSlows(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveHoldSnares(const uint32 owner_id, const uint32 bot_id, const bool hold_value);
	bool SaveBehindMob(const uint32 owner_id, const uint32 bot_id, const bool behindmob_value);
	...
	bool SaveDispelDelay(const uint32 owner_id, const uint32 bot_id, const uint32 dispel_delay_value);
	bool SaveDotDelay(const uint32 owner_id, const uint32 bot_id, const uint32 dot_delay_value);
	bool SaveEscapeDelay(const uint32 owner_id, const uint32 bot_id, const uint32 escape_delay_value);
	bool SaveFastHealDelay(const uint32 owner_id, const uint32 bot_id, const uint32 fheal_delay_value);
	bool SaveHateReduxDelay(const uint32 owner_id, const uint32 bot_id, const uint32 hateredux_delay_value);
	...
	bool SaveInCombatBuffDelay(const uint32 owner_id, const uint32 bot_id, const uint32 incombatbuff_delay_value);
	bool SaveLifetapDelay(const uint32 owner_id, const uint32 bot_id, const uint32 lifetap_delay_value);
	bool SaveMezDelay(const uint32 owner_id, const uint32 bot_id, const uint32 mez_delay_value);
	bool SaveNukeDelay(const uint32 owner_id, const uint32 bot_id, const uint32 nuke_delay_value);
	bool SaveRootDelay(const uint32 owner_id, const uint32 bot_id, const uint32 root_delay_value);
	bool SaveSlowDelay(const uint32 owner_id, const uint32 bot_id, const uint32 slow_delay_value);
	bool SaveSnareDelay(const uint32 owner_id, const uint32 bot_id, const uint32 snare_delay_value);
	bool SaveBuffThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 buff_threshold_value);
	bool SaveCompleteHealThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 cheal_threshold_value);
	bool SaveCureThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 cure_threshold_value);
	bool SaveDebuffThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 debuff_threshold_value);
	bool SaveDispelThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 dispel_threshold_value);
	bool SaveDotThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 dot_threshold_value);
	bool SaveEscapeThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 escape_threshold_value);
	bool SaveFastHealThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 fheal_threshold_value);
	bool SaveHateReduxThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 hateredux_threshold_value);
	...
	bool SaveInCombatBuffThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 incombatbuff_threshold_value);
	bool SaveLifetapThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 lifetap_threshold_value);
	bool SaveMezThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 mez_threshold_value);
	bool SaveNukeThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 nuke_threshold_value);
	bool SaveRootThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 root_threshold_value);
	bool SaveSlowThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 slow_threshold_value);
	bool SaveSnareThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 snare_threshold_value);
	bool SaveBuffMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 buff_min_threshold_value);
	bool SaveCureMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 cure_min_threshold_value);
	bool SaveDebuffMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 debuff_min_threshold_value);
	bool SaveDispelMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 dispel_min_threshold_value);
	bool SaveDotMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 dot_min_threshold_value);
	bool SaveEscapeMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 escape_min_threshold_value);
	bool SaveHateReduxMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 hateredux_min_threshold_value);
	bool SaveInCombatBuffMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 incombatbuffmin_threshold_value);
	bool SaveLifetapMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 lifetap_min_threshold_value);
	bool SaveMezMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 mez_min_threshold_value);
	bool SaveNukeMinThreshold(const uint32 owner_id, const uint32 bot_id, const uint8 nuke_min_threshold_value);
	...
	public:
		...
		static const char* SaveHoldResists();
		...
		static const char* SaveDispelDelay();
		static const char* SaveDotDelay();
		static const char* SaveEscapeDelay();
		static const char* SaveFastHealDelay();
		static const char* SaveHateReduxDelay();
		static const char* SaveHealDelay();
		static const char* SaveHotHealDelay();
		static const char* SaveInCombatBuffDelay();
		static const char* SaveLifetapDelay();
		static const char* SaveMezDelay();
		static const char* SaveNukeDelay();
		static const char* SaveRootDelay();
		static const char* SaveSlowDelay();
		static const char* SaveSnareDelay();
		static const char* SaveBuffThreshold();
		static const char* SaveCompleteHealThreshold();
		static const char* SaveCureThreshold();
		static const char* SaveDebuffThreshold();
		static const char* SaveDispelThreshold();
		static const char* SaveDotThreshold();
		static const char* SaveEscapeThreshold();
		static const char* SaveFastHealThreshold();
		static const char* SaveHateReduxThreshold();
		static const char* SaveHealThreshold();
		static const char* SaveHotHealThreshold();
		static const char* SaveInCombatBuffThreshold();
		static const char* SaveLifetapThreshold();
		static const char* SaveMezThreshold();
		static const char* SaveNukeThreshold();
		static const char* SaveRootThreshold();
		static const char* SaveSlowThreshold();
		static const char* SaveSnareThreshold();
		static const char* SaveBuffMinThreshold();
		static const char* SaveCureMinThreshold();
		static const char* SaveDebuffMinThreshold();
		static const char* SaveDispelMinThreshold();
		static const char* SaveDotMinThreshold();
		static const char* SaveEscapeMinThreshold();
		static const char* SaveHateReduxMinThreshold();
		static const char* SaveInCombatBuffMinThreshold();
		static const char* SaveLifetapMinThreshold();
		static const char* SaveMezMinThreshold();
		static const char* SaveNukeMinThreshold();
