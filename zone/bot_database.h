...
public:
	...
	bool SaveHoldDebuffs(const uint32 owner_id, const uint32 bot_id, const uint8 hdebuffs_value);
	bool SaveHoldDispels(const uint32 owner_id, const uint32 bot_id, const uint8 hdispels_value);
	bool SaveHoldEscapes(const uint32 owner_id, const uint32 bot_id, const uint8 hescapes_value);
	bool SaveHoldHateRedux(const uint32 owner_id, const uint32 bot_id, const uint8 hhateredux_value);
	bool SaveHoldHeals(const uint32 owner_id, const uint32 bot_id, const uint8 hheals_value);
	bool SaveHoldInCombatBuffs(const uint32 owner_id, const uint32 bot_id, const uint8 hicb_value);
	bool SaveHoldInCombatBuffSongs(const uint32 owner_id, const uint32 bot_id, const uint8 hicbs_value);
	bool SaveHoldLifetaps(const uint32 owner_id, const uint32 bot_id, const uint8 hlifetaps_value);
	...
	bool SaveHoldPreCombatBuffSongs(const uint32 owner_id, const uint32 bot_id, const uint8 hpcbs_value);
	bool SaveHoldRoots(const uint32 owner_id, const uint32 bot_id, const uint8 hroots_value);
	bool SaveHoldSlows(const uint32 owner_id, const uint32 bot_id, const uint8 hslows_value);
	bool SaveHoldSnares(const uint32 owner_id, const uint32 bot_id, const uint8 hsnares_value);
