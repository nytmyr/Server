...
public:
	...
	inline bool GetDefaultSpellHold(uint16 spellType) const { return _spellSettings[spellType].defaultHold; } //TODO with client changes
	bool SetDefaultSpellHold(uint16 spellType);
	inline uint16 GetDefaultSpellDelay(uint16 spellType) const { return _spellSettings[spellType].defaultDelay; } //TODO with client changes
	uint16 SetDefaultSpellDelay(uint16 spellType);
	inline uint8 GetDefaultSpellMinThreshold(uint16 spellType) const { return _spellSettings[spellType].defaultMinThreshold; } //TODO with client changes
	uint8 SetDefaultSpellMinThreshold(uint16 spellType);
	inline uint8 GetDefaultSpellMaxThreshold(uint16 spellType) const { return _spellSettings[spellType].defaultMaxThreshold; } //TODO with client changes
	uint8 SetDefaultSpellMaxThreshold(uint16 spellType);

	inline bool GetSpellHold(uint16 spellType) const { return _spellSettings[spellType].hold; } //TODO with client changes
	void SetSpellHold(uint16 spellType, bool holdStatus);
	inline uint16 GetSpellDelay(uint16 spellType) const { return _spellSettings[spellType].delay; } //TODO with client changes
	void SetSpellDelay(uint16 spellType, uint16 delayValue);
	inline uint8 GetSpellMinThreshold(uint16 spellType) const { return _spellSettings[spellType].minThreshold; } //TODO with client changes
	void SetSpellMinThreshold(uint16 spellType, uint8 thresholdValue);
	inline uint8 GetSpellMaxThreshold(uint16 spellType) const { return _spellSettings[spellType].maxThreshold; } //TODO with client changes				
