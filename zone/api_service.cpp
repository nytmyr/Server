...
Json::Value ApiGetMobListDetail(EQ::Net::WebsocketServerConnection *connection, Json::Value params)
{
	...
	for (auto &iter : list) {
		...
		row["has_shield_equiped"]         = mob->HasShieldEquipped();
		...
		row["has_two_hand_blunt_equiped"] = mob->HasTwoHandBluntEquipped();
		...
		row["spell_ac_bonuses"]           = mob->GetSpellACBonuses();
		row["spell_str_bonuses"]          = mob->GetSpellSTRBonuses();
		row["spell_sta_bonuses"]          = mob->GetSpellSTABonuses();
		row["spell_agi_bonuses"]          = mob->GetSpellAGIBonuses();
		row["spell_dex_bonuses"]          = mob->GetSpellDEXBonuses();
		row["spell_wis_bonuses"]          = mob->GetSpellWISBonuses();
		row["spell_int_bonuses"]          = mob->GetSpellINTBonuses();
		row["spell_cha_bonuses"]          = mob->GetSpellCHABonuses();
		row["spell_atk_bonuses"]          = mob->GetSpellATKBonuses();
		row["spell_mana_bonuses"]         = mob->GetSpellManaBonuses();
		row["spell_cr_bonuses"]           = mob->GetSpellCRBonuses();
		row["spell_fr_bonuses"]           = mob->GetSpellFRBonuses();
		row["spell_dr_bonuses"]           = mob->GetSpellDRBonuses();
		row["spell_pr_bonuses"]           = mob->GetSpellPRBonuses();
		row["spell_mr_bonuses"]           = mob->GetSpellMRBonuses();
